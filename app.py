...
sym_des = pd.read_csv(os.path.join(base_dir, 'notebooks/data/symtoms_df.csv'))
precautions = pd.read_csv(os.path.join(base_dir, 'notebooks/data/precautions_df.csv'))
workout = pd.read_csv(os.path.join(base_dir, 'notebooks/data/workout_df.csv'))
description = pd.read_csv(os.path.join(base_dir, 'notebooks/data/description.csv'))
medications = pd.read_csv(os.path.join(base_dir, 'notebooks/data/medications.csv'))
diets = pd.read_csv(os.path.join(base_dir, 'notebooks/data/diets.csv'))

# Load model and preprocessing artifacts
svc = pickle.load(open(os.path.join(base_dir, 'artifacts/model.pkl'), 'rb'))
preprocessor = pickle.load(open(os.path.join(base_dir, 'artifacts/preprocessor.pkl'), 'rb'))
label_encoder = pickle.load(open(os.path.join(base_dir, 'artifacts/label_encoder.pkl'), 'rb'))
...
def index():
    if request.method == 'POST':
        ...
        if not symptoms:
            return render_template('index.html', symptoms=list(symptoms_dict.keys()), error="Please select at least one symptom")
        ...
        input_df = pd.DataFrame([input_data], columns=symptoms_dict.keys())
        input_df = pd.DataFrame(preprocessor.transform(input_df), columns=preprocessor.get_feature_names_out())
